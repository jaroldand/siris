...
public class BaseKeysController<T extends BaseEntity> {
	...
	public DeferredResult<ResponseEntity<T>> getEntityByKey(@MatrixVariable(pathVar = "key") Map<String, Object> key) {
	...
	@PostMapping
	public DeferredResult<ResponseEntity<Boolean>> setInsert(@RequestBody T entity) {
		String user = HelperController.getCodUser();
		return AsyncResult.Call(() -> {
	...
	public DeferredResult<ResponseEntity<Boolean>> updateByKey(@MatrixVariable(pathVar = "key") Map<String, Object> key, @RequestBody T entity) {
		String user = HelperController.getCodUser();
		return AsyncResult.Call(() -> {
	...
	public DeferredResult<ResponseEntity<Boolean>> deleteByKey(@MatrixVariable(pathVar = "key") Map<String, Object> key, @RequestBody T entity) {
		String user = HelperController.getCodUser();
		return AsyncResult.Call(() -> {
